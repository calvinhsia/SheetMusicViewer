...
namespace Tests {
    ...
    public class UnitTest1 : TestBase {
        ...
        readonly string root2 = @"C:\Users\calvinh\OneDrive\SheetMusic";
        ...
        public async Task TestStressOnePage() {
            await RunInSTAExecutionContextAsync(async () => {
                var pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\Be Our Guest - G Major - MN0174098.pdf"; var pageNo = 1;
                //var pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\Bohemian Rhapsody - Bb Major.pdf";
                //var pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\HisTheme.pdf";
                //var pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Ragtime\Collections\Best of Ragtime.pdf";                var pageNo = 2;
        ...
        public async Task TestStressOnePageMultiChecksum() {
            await RunInSTAExecutionContextAsync(async () => {
                //var pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\Be Our Guest - G Major - MN0174098.pdf";
                //pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\Bohemian Rhapsody - Bb Major.pdf";
                //pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Pop\PopSingles\HisTheme.pdf";
                //pdfFileName = @"C:\Users\calvinh\OneDrive\SheetMusic\Ragtime\Collections\Best of Ragtime.pdf";
                var testw = new Window();
                var ctsDone = new CancellationTokenSource();
                testw.Closed += (o, e) => {
                    ctsDone.Cancel();
...
";
                ...
                testw.Content = grid;
                testw.Show();
                var folder = @"C:\Users\calvinh\OneDrive\SheetMusic\Ragtime\Collections";
